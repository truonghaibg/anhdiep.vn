    ...
    <div class="content mt-3">
        <div class="form-group">
            <form id="category-product-id" action="" method="post">
                ...
                <div class="form-group">
                    <a class="btn btn-outline-warning btn-sm" href="{{ url('backend/delivery') }}">Go back</a>
                    <a class="btn btn-outline-primary btn-sm" href="{{ url('backend/delivery/edit', $item->id) }}">Edit record</a>
                    <a class="btn btn-outline-danger btn-sm" href="{{ url("backend/delivery/delete", $item->id) }}" onclick="ad_delete()">Delete record</a>
                </div>
            </form>
        </div>
    </div><!-- .content -->
