        ...
        <div class="form-group">
            <form id="category-product-id" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-outline-primary btn-sm" href="{{ url('backend/category-product/edit', $category->id) }}">Edit record</a>
                    <a class="btn btn-outline-danger btn-sm" href="{{ url("backend/category-product/delete", $category->id) }}" onclick="ad_delete()">Delete record</a>
                </div>
            </form>
        </div>
    </div><!-- .content -->
