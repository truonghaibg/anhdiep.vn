<html>
    <head>
        ...
        <link rel="icon" href="{{URL::to('admin/images/favicon.ico')}}" type="image/x-icon">
        <!-- BEGIN: script -->
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js"></script>
        <script src="{{URL::to('admin/assets/js/anhdiep-script.js')}}"></script>

        <script src="{{ URL::to('laravel/public/vendor/unisharp/laravel-ckeditor/ckeditor.js') }}"></script>
        <!-- END: script -->
        ...
        <link rel='stylesheet' type='text/css' href="{{URL::asset('admin/assets/css/lib/vector-map/jqvmap.min.css')}}">
        <!-- END: stylesheet -->
    </head>

    <body>
        {{--Left Panel--}}
        @include('backend.layouts.left-panel')
        {{--Left Panel--}}

        {{--Right Panel--}}
        @include('backend.layouts.right-panel')
        {{--#right-panel--}}
    </body>
</html>