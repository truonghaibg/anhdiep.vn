...
<head>
    ...
    <link rel="stylesheet" type='text/css' href="{{URL::asset('/assets/css/flag-icon.min.css')}}">
    <link rel="stylesheet" type='text/css' href="{{URL::asset('/assets/css/cs-skin-elastic.css')}}">
    <link rel="stylesheet" type='text/css' href="{{URL::asset('assets/scss/style.css')}}">
    <link rel='stylesheet' type='text/css' href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800'>
    <link rel='stylesheet' type='text/css' href="{{URL::asset('assets/css/lib/vector-map/jqvmap.min.css')}}">
    <!-- END: stylesheet -->
</head>
