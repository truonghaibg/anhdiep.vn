...
@section('content')
    <div class="content mt-3">
        <div class="form-group">
            <form id="payment-id" action="" method="post">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-outline-primary btn-sm" href="{{ url('backend/payment/edit', $item->id) }}">Edit record</a>
                    <a class="btn btn-outline-danger btn-sm" href="{{ url("backend/payment/delete", $item->id) }}" onclick="ad_delete()">Delete record</a>
                </div>
            </form>
        </div>
    </div><!-- .content -->
