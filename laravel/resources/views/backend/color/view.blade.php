    ...
    <div class="content mt-3">
        <div class="form-group">
            <form id="category-product-id" action="" method="post">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <img src="{{$item->image}}" alt="Hinh anh san pham {{$item->id}} - {{$item->name}}">
                            <div class="text-block"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <a class="btn btn-outline-warning btn-sm" href="{{ url('backend/color') }}">Go back</a>
                    <a class="btn btn-outline-primary btn-sm" href="{{ url('backend/color/edit', $item->id) }}">Edit record</a>
                    <a class="btn btn-outline-danger btn-sm" href="{{ url("backend/color/delete", $item->id) }}" onclick="ad_delete()">Delete record</a>
                </div>
            </form>
        </div>
    </div><!-- .content -->
